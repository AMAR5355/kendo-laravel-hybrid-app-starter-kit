...
<body>
	<div class="welcome">
        ...
        <p><a href="{{ action('User\LoginController@showLogin') }}">Login</a>
            | <a href="{{ action('User\RegisterController@showRegister') }}">Register</a>
            | <a href="{{ action('ContactController@index') }}">Contact Us</a></p>
	</div>
</body>
</html>
